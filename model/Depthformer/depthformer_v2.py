...
from .decoder_v2 import DepthFormerDecoderV2
...
class DepthformerV2(nn.Module):
    def __init__(self, backend, opt,
                 min_depth: float, max_depth: float):
        super(DepthformerV2, self).__init__()
        self.encoder = Encoder(backend)
        self.decoder = DepthFormerDecoderV2(
...
if __name__ == '__main__':
    ...
    net = DepthformerV2.build(opt={"hidden_dim": 512, "num_heads": 4, "img_size": (480, 640)},

...
class DepthFormerDecoderV3(nn.Module):
    ...
    def __init__(self,
        ...
        self.vit_dims = [hidden_dim // 16, hidden_dim // 4, hidden_dim]
        ...
        self.regressor = nn.Sequential(nn.Linear(hidden_dim, 256),      ## bins 수로 만들기
                                       nn.LeakyReLU(),
                                       nn.Linear(256, 256),
                                       nn.LeakyReLU(),
                                       nn.Linear(256, 256))

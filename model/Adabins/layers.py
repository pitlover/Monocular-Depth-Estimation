...
class PatchTransformerEncoder(nn.Module):
    def __init__(self, in_channels, patch_size=10, embedding_dim=128, num_heads=4):
        ...
        #                                    kernel_size=patch_size, stride=patch_size, padding=0)  # Github ver.
        self.embedding_encoder = nn.Conv2d(
    ...
    def forward(self, x):
        ...
        embeddings = self.embedding_encoder(x).flatten(2)  # .shape = n,c,s = n, embedding_dim, s

...
class mViT(nn.Module):
    def __init__(self, in_channels, n_query_channels=128, patch_size=16, dim_out=256,
        ...
        # self.conv3x3 = nn.Conv2d(in_channels, embedding_dim, kernel_size=3, stride=1, padding=1)  # Github ver.
        self.embedding_conv = nn.Conv2d(in_channels, embedding_dim,
                                        kernel_size=3, stride=1, padding=1)  # Checkpoint ver.
    ...
    def forward(self, x):
        ...
        # x = self.conv3x3(x)  # Github ver.
        x = self.embedding_conv(x)  # Checkpoint ver.

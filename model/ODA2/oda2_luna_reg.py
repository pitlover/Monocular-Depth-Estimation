...
from .oda2_luna_reg_decoder import ODA2LunaRegDecoder


class ODA2LunaRegModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.encoder = swin
        self.decoder = ODA2LunaRegDecoder(
            decoder_channels,
...
if __name__ == '__main__':
    net = ODA2LunaRegModel(decoder_channels=1536, num_aux=256, aux_dims=256, num_heads=4,

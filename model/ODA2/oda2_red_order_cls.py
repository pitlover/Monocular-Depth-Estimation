...
from .oda2_red_order_cls_decoder import OrderedReductionClsDecoder


class ODA2OrderedRedClsModel(nn.Module):
    ...
    def __init__(self,
        ...
        swin_kwargs = dict(pretrain_img_size=224, patch_size=4,
                           ...
                           drop_prob=0.1, attn_drop_prob=0.0, path_drop_prob=0.3)
        ...
        self.encoder = swin
        self.decoder = OrderedReductionClsDecoder(
            dec_dim,
...
if __name__ == '__main__':
    net = ODA2OrderedRedClsModel(dec_dim=512, num_heads=16, num_repeats=3, num_emb=128, reduction_ratio=8,

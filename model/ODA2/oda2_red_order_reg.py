...
from .oda2_red_order_reg_decoder import OrderedReductionRegDecoder


class ODA2OrderedRedRegModel(nn.Module):
    ...
    def __init__(self,
        ...
        swin_kwargs = dict(pretrain_img_size=224, patch_size=4,
                           ...
                           drop_prob=0.1, attn_drop_prob=0.0, path_drop_prob=0.2)
        ...
        self.encoder = swin
        self.decoder = OrderedReductionRegDecoder(
            dec_dim,
    ...
    def build(cls, opt, min_depth: float, max_depth: float):
        ...
        m = cls(
            ...
            num_emb=opt["num_emb"],
            reduction_ratio=opt.get("reduction_ratio", 8),
            min_depth=min_depth,
            max_depth=max_depth,
...
if __name__ == '__main__':
    net = ODA2OrderedRedRegModel(dec_dim=512, num_heads=16, num_repeats=3, num_emb=128, reduction_ratio=8,

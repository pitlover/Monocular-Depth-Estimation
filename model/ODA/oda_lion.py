...
from .decoder_lion import ODALionDecoder
from .layer_utils import ScaledSigmoid


class ODALionModel(nn.Module):
    ...
    def __init__(self,
        ...
        #         nn.init.uniform_(module.weight, -0.005, 0.005)
    ...
    def forward(self, x: torch.Tensor) -> Tuple[torch.Tensor, Tuple[torch.Tensor, ...]]:
        ...
        out, attn_weights = self.decoder(features, (new_h, new_w))
...
if __name__ == '__main__':
    net = ODALionModel(input_size=(384, 1152), decoder_channels=2048,

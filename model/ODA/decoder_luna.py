...
class ODALunaDecoder(nn.Module):
    ...
    def __init__(self,
        ...
        self.block32_post = nn.Sequential(
            ...
            ConvBN(self.output_channels[3], self.output_channels[2], 1, **post_common_kwargs),
        )
        ...
        self.block16_post = nn.Sequential(
            ...
            ConvBN(self.output_channels[2], self.output_channels[1], 1, **post_common_kwargs),
        )
        ...
        self.block8_post = nn.Sequential(
            ...
            ConvBN(self.output_channels[1], self.output_channels[0], 1, **post_common_kwargs),
        )
        ...
        self.block4_post = nn.UpsamplingBilinear2d(scale_factor=2)

        final_channels = self.output_channels[0]  # [128,]
        self.block2 = nn.Sequential(
            ConvBN(self.output_channels[0], final_channels, 3, **pre_common_kwargs),
